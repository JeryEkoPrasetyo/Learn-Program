    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td><img src="../gambar/<?php echo tutors_foto($r1['id']) ?>" style="max-height:100px;max-width:1100px" />
                </td>
                ...
                <td>
                    ...
                    <a href="tutors.php?op=delete&id=<?php echo $r1['id'] ?>" onclick="return confirm('apakah yakin mau hapus data?')">
