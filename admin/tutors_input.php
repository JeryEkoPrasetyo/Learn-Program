...
if (isset($_POST['simpan'])) {
    ...
    //Array ( [foto] => Array ( [name] => jryyyyyyyyyyyyyyyyyyyyyyyyyyyyy.jpg [type] => image/jpeg [tmp_name] => C:\xampp\tmp\php76C8.tmp [error] => 0 [size] => 221893 ) )
    //print_r($_FILES);
    if ($_FILES['foto']['name']) {
        ...
        //Array ( [dirname] => . [basename] => jryyyyyyyyyyyyyyyyyyyyyyyyyyyyy.jpg [extension] => jpg [filename] => jryyyyyyyyyyyyyyyyyyyyyyyyyyyyy )
        $ekstensi_yang_diperbolehkan = array("jpg", "jpeg", "png", "gif");
        if (!in_array($foto_ekstensi, $ekstensi_yang_diperbolehkan)) {
            $error = "Ekstensi yang diperbolehkan adalah jpg,jpeg, png, gif";
        }
    }
