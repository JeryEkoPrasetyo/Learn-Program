...
if (isset($_POST['simpan'])) {
    ...
    if (md5($password_lama) != $r1['password']) {
        $err .= "<li>Password yang kamu masukkan tidak sesuai dengan password sebelumnya</li>";
    }
    ...
    if (strlen($password) < 6) {
        $err .= "<li>Panjang karakter yang diizikan untuk password adalah 6 karakter</li>";
    }
