...
<form class="row g-3" method="get">
    <div class="col-auto">
        <input type="text" class="form-control" placeholder="Masukan Kata Kunci" name="Kata Kunci" value="<?php echo $katakunci ?>" />
    </div>
    <div class="col-auto">
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td><img src="../gambar/<?php echo partners_foto($r1['id']) ?>" style="max-height:100px;max-width:1100px" />
                </td>
                ...
                <td>
                    ...
                    <a href="partners.php?op=delete&id=<?php echo $r1['id'] ?>" onclick="return confirm('apakah yakin mau hapus data?')">
