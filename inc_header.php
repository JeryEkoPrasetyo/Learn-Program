...
<head>
    ...
    <title>Programming di Magis.</title>
...
<body>
    <nav>
        <div class="wrapper">
            <div class="logo"><a href='<?php echo url_dasar() ?>'>Magis7</a></div>
            <div class="menu">
                <ul>
                    <li><a href="<?php echo url_dasar() ?>#home">Home</a></li>
                    <li><a href="<?php echo url_dasar() ?>#courses">Courses</a></li>
                    <li><a href="<?php echo url_dasar() ?>#tutors">Mgs7</a></li>
                    <li><a href="<?php echo url_dasar() ?>#partners">Education</a></li>
